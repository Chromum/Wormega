    ...
    public void OnCollisionEnter(Collision collision)
    {
        if (hasCharged == true)
        {
            if (collision.collider.tag == "Player")
            {
                ...
                float damage = Mathf.Lerp(DifficultyStats.DamageMultiplier * EnemyStats.minAttackDamage,
                    DifficultyStats.DamageMultiplier * EnemyStats.maxAttackDamage, damageRatio);
